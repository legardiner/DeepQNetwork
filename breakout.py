...
parser.add_argument('--learning_rate', default=0.0002, help='Learning rate for \
                    optimizer')
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        state, stacked_frames = stack_frames(stacked_frames, state, stack_size, True)
    ...
    #         print("Step: {0}\tExplore Probability: {1}".format(step, explore_probability))
            ...
            if done:
                ...
                next_state, stacked_frames = stack_frames(stacked_frames, next_state, stack_size, False)
