...
parser.add_argument('--log_dir', default='mspacman/logs',
                    help='Path to directory for logs for tensorboard')
parser.add_argument('--model_dir', default='mspacman/model',
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(int(args.epochs)):
            ...
            if epoch % 10 == 0:
                    saver.save(sess, "./mspacman/model{0}_{1}.ckpt".
